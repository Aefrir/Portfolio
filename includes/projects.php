  ...
  <div class="project-content">
    <article>
      ...
      <section class="bottom-section">
        <p>I built projects to strengthen my web fundamentals, including an extensive HTML reference table and an interactive Game of Thrones image map linking regions to their wiki pages.</p>
        <div class="links">
          <a href="projects/html/image-map/opdracht-5.html" class="project-link" target="_blank">Image map</a>
          <a href="projects/html/html-table/index.html" class="project-link" target="_blank">HTML Table</a>
        </div>
      </section>
    </article>
    <article>
      ...
      <section class="bottom-section">
        <p>I recreated a medical webshop design provided in Figma using only HTML and CSS. The result is a 1:1 responsive layout that works seamlessly across desktop and mobile screens, showcasing my attention to detail and front-end styling skills.</p>
        <div class="links">
          <a href="projects/css/index.html" class="project-link" target="_blank">Webshop</a>
        </div>
      </section>
    </article>
    <article>
    ...
    <article>
      ...
      <section class="bottom-section">
        ...
        <div class="links">
          <a href="projects/js/dom/index.html" class="project-link" target="_blank">DOM Webpage</a>
          <a href="projects/js/json/index.html" class="project-link" target="_blank">JSON Data Webpage</a>
        </div>
      </section>
    </article>
    <article>
